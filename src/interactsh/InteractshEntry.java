...
// ADDITIONAL: 0\n\n;; QUESTION SECTION:\n;c4jup534f3acspvifdr0cru63feyyyyyn.interact.sh.\tIN\t
// A\n","raw-response":";; opcode: QUERY, status: NOERROR, id: 52297\n;; flags: qr aa cd; QUERY: 1,
...
// {"protocol":"http","unique-id":"c4jv8mb4f3adocqjsqe0cru9esoyyyyyn","full-id":"c4jv8mb4f3adocqjsqe0cru9esoyyyyyn","raw-request":"GET
...
// {"protocol":"smtp","unique-id":"c4l8o21gbfmkbnhdg64gwbkgvwnbfasfu","full-id":"c4l8o21gbfmkbnhdg64gwbkgvwnbfasfu","raw-request":"Received:
// from s5.eternalimpact.info (s5.eternalimpact.info. [167.86.101.24])\r\n by interact.sh.
// (interactsh) with SMTP\r\n for \u003cfoobar@c4l8o21gbfmkbnhdg64gwbkgvwnbfasfu.interact.sh\u003e;
// Sat, 28 Aug 2021 19:19:09 +0000 (UTC)\r\nReceived: from authenticated-user (s5.eternalimpact.info
// [167.86.101.24])\r\n\t(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits))\r\n\t(No
// client certificate requested)\r\n\tby s5.eternalimpact.info (Postfix) with ESMTPSA id
// 54FE3662239\r\n\tfor \u003cfoobar@c4l8o21gbfmkbnhdg64gwbkgvwnbfasfu.interact.sh\u003e; Sat, 28
// Aug 2021 19:19:09 +0000 (UTC)\r\nDKIM-Signature: v=1; a=rsa-sha256;
// c=relaxed/simple;\r\n\td=s5.eternalimpact.info; s=mail;
...
// Sat, 28 Aug 2021 19:19:09 +0000\r\nTo:
// foobar@c4l8o21gbfmkbnhdg64gwbkgvwnbfasfu.interact.sh\r\nFrom: Anonymousemail
// \u003cnoreply@anonymousemail.me\u003e\r\nSubject: Test\r\nMessage-ID:
// \u003c8d2a3a8f07c5bd642e12f7ea4a48245a@anonymousemail.me\u003e\r\nList-Unsubscribe:
// \u003cmailto:contact@anonymousemail.me?subject=unsubscribe\u003e,
// \u003chttps://anonymousemail.me/unsubscribe.php?email=foobar@c4l8o21gbfmkbnhdg64gwbkgvwnbfasfu.interact.sh\u003e\r\nMIME-Version:
...
// charset=us-ascii\r\n\r\n\u003cp\u003e\u003cspan style=\"color:#c0392b\"\u003ePowered by
// \u003cstrong\u003eAnonymousemail\u003c/strong\u003e\u0026nbsp;\u0026rarr;
// \u003c/span\u003e\u003ca href=\"https://anonymousemail.cc/premium.php?source=email\"
// style=\"text-decoration:none;\"\u003e\u003cspan style=\"color:#df7401\"\u003eJoin
// Us!\u003c/span\u003e\u003c/a\u003e\u003c/p\u003eHello
